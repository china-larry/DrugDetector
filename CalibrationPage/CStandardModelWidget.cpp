...
void CStandardModelWidget::_InitWidget()
{
    ...
    m_pPhotoShowLabel->setMinimumSize(450, 300);
    ...
    m_pCurveGraphicsView->setMinimumSize(450, 300);
    //
    m_pDeriveButton = new QPushButton(tr("Derive"), this);
    m_pDeriveButton->setFixedSize(100, 30);
    //
    // qss
...
void CStandardModelWidget::_InitLayout()
{
    ...
    pLayout->addWidget(_CreateBrightnessValueGroup());
    //
    QGridLayout *pGridLayout = new QGridLayout;
    pGridLayout->setHorizontalSpacing(50);
